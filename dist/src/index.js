...
export default forwardRef(function ActionSheet(_a, ref) {
    ...
    var _v = _a.animated, animated = _v === void 0 ? true : _v, _w = _a.closeOnPressBack, closeOnPressBack = _w === void 0 ? true : _w, _x = _a.springOffset, springOffset = _x === void 0 ? 50 : _x, _y = _a.elevation, elevation = _y === void 0 ? 5 : _y, _z = _a.defaultOverlayOpacity, defaultOverlayOpacity = _z === void 0 ? 0.3 : _z, _0 = _a.overlayColor, overlayColor = _0 === void 0 ? 'black' : _0, _1 = _a.closable, closable = _1 === void 0 ? true : _1, _2 = _a.closeOnTouchBackdrop, closeOnTouchBackdrop = _2 === void 0 ? true : _2, onTouchBackdrop = _a.onTouchBackdrop, _3 = _a.drawUnderStatusBar, drawUnderStatusBar = _3 === void 0 ? false : _3, _4 = _a.gestureEnabled, gestureEnabled = _4 === void 0 ? false : _4, _5 = _a.isModal, isModal = _5 === void 0 ? true : _5, _6 = _a.snapPoints, snapPoints = _6 === void 0 ? [100] : _6, _7 = _a.initialSnapIndex, initialSnapIndex = _7 === void 0 ? 0 : _7, _8 = _a.overdrawEnabled, overdrawEnabled = _8 === void 0 ? true : _8, _9 = _a.overdrawFactor, overdrawFactor = _9 === void 0 ? 15 : _9, _10 = _a.overdrawSize, overdrawSize = _10 === void 0 ? 100 : _10, _11 = _a.zIndex, zIndex = _11 === void 0 ? 999 : _11, _12 = _a.keyboardHandlerEnabled, keyboardHandlerEnabled = _12 === void 0 ? true : _12, ExtraOverlayComponent = _a.ExtraOverlayComponent, payload = _a.payload, safeAreaInsets = _a.safeAreaInsets, routes = _a.routes, initialRoute = _a.initialRoute, onBeforeShow = _a.onBeforeShow, enableRouterBackNavigation = _a.enableRouterBackNavigation, onBeforeClose = _a.onBeforeClose, _13 = _a.enableGesturesInScrollView, enableGesturesInScrollView = _13 === void 0 ? true : _13, disableDragBeyondMinimumSnapPoint = _a.disableDragBeyondMinimumSnapPoint, _14 = _a.top, top = _14 === void 0 ? false : _14, props = __rest(_a, ["animated", "closeOnPressBack", "springOffset", "elevation", "defaultOverlayOpacity", "overlayColor", "closable", "closeOnTouchBackdrop", "onTouchBackdrop", "drawUnderStatusBar", "gestureEnabled", "isModal", "snapPoints", "initialSnapIndex", "overdrawEnabled", "overdrawFactor", "overdrawSize", "zIndex", "keyboardHandlerEnabled", "ExtraOverlayComponent", "payload", "safeAreaInsets", "routes", "initialRoute", "onBeforeShow", "enableRouterBackNavigation", "onBeforeClose", "enableGesturesInScrollView", "disableDragBeyondMinimumSnapPoint", "top"]);
    snapPoints =
    ...
    }), visible = _16.visible, setVisible = _16.setVisible;
    ...
    var hideAnimation = React.useCallback(function (vy, callback) {
        ...
        var animation = Animated.spring(animations.translateY, __assign({ velocity: typeof vy !== 'number' ? 3.0 : vy + 1, toValue: toValue, useNativeDriver: true }, config));
        animation.start();
        setTimeout(function () {
            animation.stop();
            callback === null || callback === void 0 ? void 0 : callback({ finished: true });
    ...
    var getNextPosition = React.useCallback(function (snapIndex) {
        if (top) {
            ...
            return ((actionSheetHeight.current * snapPoints[snapIndex]) / 100 -
            ...
            <GestureHandlerRoot isModal={isModal} style={styles.parentContainer}>
              <PanGestureRefContext.Provider value={context}>
                ...
                styles.parentContainer,
                {
                    ...
                    <Animated.View pointerEvents="box-none" style={__assign(__assign(__assign(__assign(__assign(__assign(__assign({}, (top
                ? {
                    borderBottomRightRadius: ((_c = props.containerStyle) === null || _c === void 0 ? void 0 : _c.borderBottomRightRadius) || 10,
                    borderBottomLeftRadius: ((_d = props.containerStyle) === null || _d === void 0 ? void 0 : _d.borderBottomLeftRadius) || 10,
                    borderTopRightRadius: ((_e = props.containerStyle) === null || _e === void 0 ? void 0 : _e.borderTopRightRadius) ||
                        undefined,
                    borderTopLeftRadius: ((_f = props.containerStyle) === null || _f === void 0 ? void 0 : _f.borderTopLeftRadius) ||
                        undefined,
                }
                : {
                    borderTopRightRadius: ((_g = props.containerStyle) === null || _g === void 0 ? void 0 : _g.borderTopRightRadius) || 10,
                    borderTopLeftRadius: ((_h = props.containerStyle) === null || _h === void 0 ? void 0 : _h.borderTopLeftRadius) || 10,
                    borderBottomLeftRadius: ((_j = props.containerStyle) === null || _j === void 0 ? void 0 : _j.borderBottomLeftRadius) ||
                        undefined,
                    borderBottomRightRadius: ((_k = props.containerStyle) === null || _k === void 0 ? void 0 : _k.borderBottomRightRadius) ||
                        undefined,
                })), { backgroundColor: ((_l = props.containerStyle) === null || _l === void 0 ? void 0 : _l.backgroundColor) || 'white', borderRadius: ((_m = props.containerStyle) === null || _m === void 0 ? void 0 : _m.borderRadius) || undefined, width: ((_o = props.containerStyle) === null || _o === void 0 ? void 0 : _o.width) || '100%' }), getElevation(typeof elevation === 'number' ? elevation : 5)), { flex: undefined, height: dimensions.height, maxHeight: dimensions.height }), (top
                ? {
                ...
                transform: [
                    {
                      ...
                      {dimensions.height === 0 ? null : (<PanGestureHandler {...panHandlers} ref={panHandlerRef}>
                          <Animated.View {...handlers.panHandlers} onLayout={onSheetLayout} ref={panViewRef} testID={(_p = props.testIDs) === null || _p === void 0 ? void 0 : _p.sheet} style={[
                    styles.container,
                    {
                    ...
                    props.containerStyle,
                    {
                        ...
                        position: 'absolute',
                        top: -50,
                        backgroundColor: ((_q = props.containerStyle) === null || _q === void 0 ? void 0 : _q.backgroundColor) ||
                            'white',
                        width: '100%',
                        borderTopRightRadius: ((_r = props.containerStyle) === null || _r === void 0 ? void 0 : _r.borderRadius) || 10,
                        borderTopLeftRadius: ((_s = props.containerStyle) === null || _s === void 0 ? void 0 : _s.borderRadius) || 10,
                        transform: [
                            {
                    ...
                    height: overdrawSize,
                    bottom: -overdrawSize,
                    backgroundColor: ((_t = props.containerStyle) === null || _t === void 0 ? void 0 : _t.backgroundColor) || 'white',
                    width: ((_u = props.containerStyle) === null || _u === void 0 ? void 0 : _u.width) || dimensions.width,
                }}/>) : null}
                    </Animated.View>
